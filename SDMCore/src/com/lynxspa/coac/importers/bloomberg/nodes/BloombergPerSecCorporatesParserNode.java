 ...
 */
@NodeBeautifier(description="Bloomberg Parser Persecurity Corporate", category="CorporateActionsCore", smallIcon = "../../../../../lynxit/fpm/nodes/icons/parser_16.gif", largeIcon = "../../../../../lynxit/fpm/nodes/icons/parser_32.gif")
public class BloombergPerSecCorporatesParserNode extends ParserNode {
	...
	public BloombergPerSecCorporatesParserNode(){
		super();
		newMessage();
