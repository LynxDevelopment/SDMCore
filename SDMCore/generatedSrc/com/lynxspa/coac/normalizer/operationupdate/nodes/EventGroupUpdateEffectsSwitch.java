// $-- src/com/lynxspa/coac/normalizer/operationupdate/nodes/EventGroupUpdateEffects.fpmswitch
...
@GeneratedType(definitionFile = "src/com/lynxspa/coac/normalizer/operationupdate/nodes/EventGroupUpdateEffects.fpmswitch")
public class EventGroupUpdateEffectsSwitch
		extends
	...
	private Logger logger_ = Logger
			.getLogger(EventGroupUpdateEffectsSwitch.class);
	...
	public EventGroupUpdateEffectsSwitch() {
		super();
	}
