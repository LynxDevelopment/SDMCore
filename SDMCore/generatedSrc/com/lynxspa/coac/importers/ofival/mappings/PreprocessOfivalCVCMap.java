// $-- src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalCVC.fpmmap
...
@GeneratedType(definitionFile = "src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalCVC.fpmmap")
public class PreprocessOfivalCVCMap
		extends
	...
	public com.lynxspa.coac.importers.EventMessageImportBean perform(
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions.getImportMessageField(input, "CVC:71-78:"),
				"yyyyMMdd");
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions
						.getImportMessageField(input, "CVC:358-365:"),
				"yyyyMMdd");
		...
		// $-- /mn:mapping-element/field/field[3]/function/function[1]
				...
				coacImportFunctions.getImportMessageField(input, "CVC:64-66:"));
		outputMessage
		...
		// $-- /mn:mapping-element/field/field[6]/function
		coacImportFunctions.getImportMessageField(input, "CVC:34-34:");
		...
		// $-- /mn:mapping-element/field/field[8]/function
		coacImportFunctions.getImportMessageField(input, "CVC:35-39:");
		...
		// $-- /mn:mapping-element/field/field[9]/function
		coacImportFunctions.getImportMessageField(input, "CVC:40-51:");
