// $-- src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalOPV.fpmmap
...
@GeneratedType(definitionFile = "src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalOPV.fpmmap")
public class PreprocessOfivalOPVMap
		extends
	...
	public com.lynxspa.coac.importers.EventMessageImportBean perform(
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions.getImportMessageField(input, "OPV:71-78:"),
				"yyyyMMdd");
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions
						.getImportMessageField(input, "OPV:183-190:"),
				"yyyyMMdd");
		...
		// $-- /mn:mapping-element/field/field[3]/function/function[1]
				...
				coacImportFunctions.getImportMessageField(input, "OPV:68-70:"));
		outputMessage
		...
		// $-- /mn:mapping-element/field/field[6]/function
		coacImportFunctions.getImportMessageField(input, "OPV:34-34:");
		...
		// $-- /mn:mapping-element/field/field[8]/function
		coacImportFunctions.getImportMessageField(input, "OPV:40-51:");
		...
		// $-- /mn:mapping-element/field/field[9]/function
		coacImportFunctions.getImportMessageField(input, "OPV:52-63:");
