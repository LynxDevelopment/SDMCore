// $-- src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalAMP.fpmmap
...
@GeneratedType(definitionFile = "src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalAMP.fpmmap")
public class PreprocessOfivalAMPMap
		extends
	...
	public com.lynxspa.coac.importers.EventMessageImportBean perform(
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions.getImportMessageField(input, "AMP:55-62:"),
				"yyyyMMdd");
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions.getImportMessageField(input, "AMP:74-81:"),
				"yyyyMMdd");
		...
		// $-- /mn:mapping-element/field/field[3]/function/function[1]
				...
				coacImportFunctions.getImportMessageField(input, "AMP:52-54:"));
		outputMessage
		...
		// $-- /mn:mapping-element/field/field[6]/function
		coacImportFunctions.getImportMessageField(input, "AMP:34-34:");
		...
		// $-- /mn:mapping-element/field/field[8]/function/function
				objectFunctions.condition(
						// $-- /mn:mapping-element/field/field[8]/function/function/function[1]
						objectFunctions.isNull(
						// $-- /mn:mapping-element/field/field[8]/function/function/function[1]/function
								coacImportFunctions.getImportMessageField(
										input, "AMP:385-396:")),
						// $-- /mn:mapping-element/field/field[8]/function/function/function[2]
						coacImportFunctions.getImportMessageField(input,
								"AMP:35-39:"),
						// $-- /mn:mapping-element/field/field[8]/function/function/function[3]
						coacImportFunctions.getImportMessageField(input,
								"AMP:385-396:")));
		...
		// $-- /mn:mapping-element/field/field[9]/function
		coacImportFunctions.getImportMessageField(input, "AMP:40-51:");
		...
		// $-- /mn:mapping-element/field/field[10]/function/function
				objectFunctions.condition(
						...
						objectFunctions.isNull(
						// $-- /mn:mapping-element/field/field[10]/function/function/function[1]/function
								coacImportFunctions.getImportMessageField(
										input, "AMP:385-396:")),
						// $-- /mn:mapping-element/field/field[10]/function/function/function[2]
						objectFunctions.stringValueOf("ISIN"),
						// $-- /mn:mapping-element/field/field[10]/function/function/function[3]
						stringFunctions.concat("IPRVID",
						// $-- /mn:mapping-element/field/field[10]/function/function/function[3]/function
