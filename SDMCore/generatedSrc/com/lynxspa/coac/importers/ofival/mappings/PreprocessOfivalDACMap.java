// $-- src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalDAC.fpmmap
...
@GeneratedType(definitionFile = "src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalDAC.fpmmap")
public class PreprocessOfivalDACMap
		extends
	...
	public com.lynxspa.coac.importers.EventMessageImportBean perform(
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions.getImportMessageField(input, "DAC:76-83:"),
				"yyyyMMdd");
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions
						.getImportMessageField(input, "DAC:509-516:"),
				"yyyyMMdd");
		...
		// $-- /mn:mapping-element/field/field[5]/function
		coacImportFunctions.getImportMessageField(input, "DAC:34-34:");
		...
		// $-- /mn:mapping-element/field/field[7]/function
		coacImportFunctions.getImportMessageField(input, "DAC:40-51:");
		...
		// $-- /mn:mapping-element/field/field[8]/function
		coacImportFunctions.getImportMessageField(input, "DAC:52-63:");
