// $-- src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalSPL.fpmmap
...
@GeneratedType(definitionFile = "src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalSPL.fpmmap")
public class PreprocessOfivalSPLMap
		extends
	...
	public com.lynxspa.coac.importers.EventMessageImportBean perform(
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions.getImportMessageField(input, "SPL:67-74:"),
				"yyyyMMdd");
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions
						.getImportMessageField(input, "SPL:422-429:"),
				"yyyyMMdd");
		...
		// $-- /mn:mapping-element/field/field[3]/function/function[1]
				...
				coacImportFunctions.getImportMessageField(input, "SPL:64-66:"));
		outputMessage
		...
		// $-- /mn:mapping-element/field/field[6]/function
		coacImportFunctions.getImportMessageField(input, "SPL:34-34:");
		...
		// $-- /mn:mapping-element/field/field[8]/function
		coacImportFunctions.getImportMessageField(input, "SPL:40-51:");
		...
		// $-- /mn:mapping-element/field/field[9]/function
		coacImportFunctions.getImportMessageField(input, "SPL:52-63:");
