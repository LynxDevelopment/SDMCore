// $-- src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalDEV.fpmmap
...
@GeneratedType(definitionFile = "src/com/lynxspa/coac/importers/ofival/mappings/preprocessOfivalDEV.fpmmap")
public class PreprocessOfivalDEVMap
		extends
	...
	public com.lynxspa.coac.importers.EventMessageImportBean perform(
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions.getImportMessageField(input, "DEV:79-86:"),
				"yyyyMMdd");
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions
						.getImportMessageField(input, "DEV:215-222:"),
				"yyyyMMdd");
		...
		// $-- /mn:mapping-element/field/field[3]/function/function[1]
				...
				coacImportFunctions.getImportMessageField(input, "DEV:52-54:"));
		outputMessage
		...
		// $-- /mn:mapping-element/field/field[6]/function
		coacImportFunctions.getImportMessageField(input, "DEV:34-34:");
		...
		// $-- /mn:mapping-element/field/field[8]/function
		coacImportFunctions.getImportMessageField(input, "DEV:40-51:");
		...
		// $-- /mn:mapping-element/field/field[9]/function
		coacImportFunctions.getImportMessageField(input, "DEV:55-66:");
