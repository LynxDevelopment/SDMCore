// $-- src/com/lynxspa/coac/importers/iberclear/mappings/preprocessIberclear.fpmmap

package com.lynxspa.coac.importers.iberclear.mappings;
...
@GeneratedType(definitionFile = "src/com/lynxspa/coac/importers/iberclear/mappings/preprocessIberclear.fpmmap")
public class PreprocessIberclearMap
		extends
	...
	public com.lynxspa.coac.importers.EventMessageImportBean perform(
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions.getImportMessageField(input, "IBC:66-73:"),
				"yyyyMMdd");
		...
		objectFunctions.parseSecureDate(
				...
				coacImportFunctions.getImportMessageField(input, "IBC:74-81:"),
				"yyyyMMdd");
		...
		// $-- /mn:mapping-element/field/field[3]/function/function[1]
				...
				coacImportFunctions
						.getImportMessageField(input, "IBC:154-161:"));
		...
		// $-- /mn:mapping-element/field/field[4]/function
		coacImportFunctions.getImportMessageField(input, "IBC:20-21:");
		...
		// $-- /mn:mapping-element/field/field[5]/function/function[1]
				coacImportFunctions.getImportMessageField(input, "IBC:8-19:"),
				// $-- /mn:mapping-element/field/field[5]/function/function[2]
				objectFunctions.getHash(
				// $-- /mn:mapping-element/field/field[5]/function/function[2]/function
						objectFunctions.stringValueOf(
						// $-- /mn:mapping-element/field/field[5]/function/function[2]/function/function
								timeFunctions.now())));
		...
		coacImportFunctions.getMessageType("HibernateResource",
				com.lynxspa.sdm.dictionaries.formats.CAFormat.IBERCLEAR,
		...
		// $-- /mn:mapping-element/field/field[7]/function
		coacImportFunctions.getImportMessageField(input, "IBC:170-170:");
