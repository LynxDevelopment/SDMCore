 ...
 */
@GeneratedType(definitionFile = "src/com/lynxspa/coac/importers/bloomberg/businessprocess/ImportBloombergPersecCorporates.fpmprocess")
public class ImportBloombergPersecCorporatesProcess extends BusinessProcess {
	/*
	...
	public ImportBloombergPersecCorporatesProcess(String id) {
		super(id);
	}
	...
	public void init() throws Exception {
		...
		// $-- /business process/BloombergParserNode/
		bloombergParserNodeNode.setErrorExtension("error");
		// $-- /business process/BloombergParserNode/
		...
		bloombergParserNodeNode
				.setErrorPath(getInputBloombergPerSecCorporatesErrorDirectory());
		...
		// $-- /business process/Commit/
		commitNode
				.setCommitEvery(getInputBloombergPerSecCorporatesCommitSize());
		// $-- /business process/Commit/
		...
		// $-- /business process/PreprocessPersecurityBloombergMap
		// instantiate and configure 'PreprocessPersecurityBloombergMap' node
		com.lynxspa.coac.importers.bloomberg.mappings.PreprocessPersecurityBloombergMap preprocessPersecurityBloombergMapNode = Interceptors
				.createNode(com.lynxspa.coac.importers.bloomberg.mappings.PreprocessPersecurityBloombergMap.class);
		preprocessPersecurityBloombergMapNode
				.setId("PreprocessPersecurityBloombergMap");
		addNode(preprocessPersecurityBloombergMapNode);
		// $-- /business process/PreprocessPersecurityBloombergMap/
		...
		// $-- /business process/FilterMessages/out/business process/PreprocessPersecurityBloombergMap/in
		filterMessagesNode
				.connectNodeToOut(preprocessPersecurityBloombergMapNode);
		filterMessagesNode
				.connectNodeToException(getDefaultExceptionHandlerNode());
		...
		// $-- /business process/PreprocessPersecurityBloombergMap/out/business process/DuplicateImportsFilter/in
		preprocessPersecurityBloombergMapNode
				.connectNodeToOut(duplicateImportsFilterNode);
		preprocessPersecurityBloombergMapNode
				.connectNodeToException(getDefaultExceptionHandlerNode());
		...
		openFileNode.init();
		preprocessPersecurityBloombergMapNode.init();
	}
