...
@GeneratedType(definitionFile = "src/com/lynxspa/coac/CorporateActions.fpmapplication")
public class CorporateActionsApplication extends ApplicationDomain {

	public CorporateActionsApplication(String id) throws Exception {
		super(id);
	}
	...
	public static void main(String[] args) {
		try {
			ApplicationDomain application = Interceptors
					.createApplicationDomain(CorporateActionsApplication.class,
							"application");
